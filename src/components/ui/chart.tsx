...
// Simple re-exports for ease-of-use in JSX
const ChartTooltip = Tooltip;
const ChartLegend = Legend;

/** Lightweight shapes compatible with Recharts without importing their types */
type RTTooltipItem = {
  color?: string;
...
/** Tooltip content props (independent of Recharts' internal types) */
type ChartTooltipContentProps = React.HTMLAttributes<HTMLDivElement> & {
  active?: boolean;
  payload?: RTTooltipItem[];
  label?: unknown;
  ...
  labelFormatter?: (label: any, payload: RTTooltipItem[]) => React.ReactNode;
  formatter?: (
    value: any,
    name: any,
    item: RTTooltipItem,
...
/** Legend content props (independent of Recharts' internal types) */
type ChartLegendContentProps = React.HTMLAttributes<HTMLDivElement> & {
  payload?: RTLegendItem[];
